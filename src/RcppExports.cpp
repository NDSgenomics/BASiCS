...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type mmu(mmuSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(HiddenBASiCS_MCMCcpp(N, Thin, Burn, Counts, BatchDesign, muSpikes, mu0, delta0, phi0, s0, nu0, theta0, mmu, s2mu, adelta, bdelta, s2delta, prior_delta, aphi, as, bs, atheta, btheta, ar, LSmu0, LSdelta0, LSphi0, LSnu0, LStheta0, sumByCellAll, sumByCellBio, sumByGeneAll, sumByGeneBio, StoreAdapt, EndAdapt, PrintProgress));
    return rcpp_result_gen;
END_RCPP
}
...
// Hidden_muUpdate
arma::mat Hidden_muUpdate(arma::vec const& mu0, arma::vec const& prop_var, arma::mat const& Counts, arma::vec const& invdelta, arma::vec const& phinu, arma::vec const& sum_bycell_bio, double const& m_mu, double const& s2_mu, int const& q0, int const& n, arma::vec& mu1, arma::vec& u, arma::vec& ind);
RcppExport SEXP _BASiCS_Hidden_muUpdate(SEXP mu0SEXP, SEXP prop_varSEXP, SEXP CountsSEXP, SEXP invdeltaSEXP, SEXP phinuSEXP, SEXP sum_bycell_bioSEXP, SEXP m_muSEXP, SEXP s2_muSEXP, SEXP q0SEXP, SEXP nSEXP, SEXP mu1SEXP, SEXP uSEXP, SEXP indSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double const& >::type m_mu(m_muSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(Hidden_muUpdate(mu0, prop_var, Counts, invdelta, phinu, sum_bycell_bio, m_mu, s2_mu, q0, n, mu1, u, ind));
    return rcpp_result_gen;
END_RCPP
}
