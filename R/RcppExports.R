...
HiddenBASiCS_MCMCcpp <- function(N, Thin, Burn, Counts, BatchDesign, muSpikes, mu0, delta0, phi0, s0, nu0, theta0, mmu, s2mu, adelta, bdelta, s2delta, prior_delta, aphi, as, bs, atheta, btheta, ar, LSmu0, LSdelta0, LSphi0, LSnu0, LStheta0, sumByCellAll, sumByCellBio, sumByGeneAll, sumByGeneBio, StoreAdapt, EndAdapt, PrintProgress) {
...
Hidden_muUpdate <- function(mu0, prop_var, Counts, invdelta, phinu, sum_bycell_bio, m_mu, s2_mu, q0, n, mu1, u, ind) {
    .Call('_BASiCS_Hidden_muUpdate', PACKAGE = 'BASiCS', mu0, prop_var, Counts, invdelta, phinu, sum_bycell_bio, m_mu, s2_mu, q0, n, mu1, u, ind)
}
